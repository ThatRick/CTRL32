...
{
    private pointHandles: UIPointHandle[] = []
    private svg: SVGSVGElement
    private polyline: SVGPolylineElement

    private snap: Vec2
    private updateRequest = null

    private parent: HTMLElement

    private svgSizeMargin = vec2(4)

    private selected: boolean

    constructor(points: Vec2[], snap: Vec2, parent: HTMLElement) {
    ...
    events = new EventEmitter<typeof this, 'lineClicked'>(this)
    ...
    requestUpdate() {
        if (!this.updateRequest) this.updateRequest = requestAnimationFrame(this.render.bind(this))
    }
}